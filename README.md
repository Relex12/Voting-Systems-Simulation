...
*   **No media influence** : The simulation supposes that every elector has a complete knowledge of the candidate's position. In the real world, voters might not have all the information they need to vote, and will try to do their best according to what they know. Media exposure of candidates and media influence on electors might even depend on their position.
*   **No voting strategy** : Regardless of their implementation, many of these voting methods have **well-known flaws**. If you are aware of theses, you should rationally betray your preferences, so that you favorite candidate has more chances to win the election. In the simulation, each elector is true to his or her preferences.
